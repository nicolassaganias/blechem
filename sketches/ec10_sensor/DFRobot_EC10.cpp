/*
 * file DFRobot_EC_10.cpp
 * @ https://github.com/DFRobot/DFRobot_EC_10
 *
...
float DFRobot_EC_10::readEC(float voltage, float temperature)
{
...
void DFRobot_EC_10::calibration(float voltage, float temperature,char* cmd)
{   
...
void DFRobot_EC_10::calibration(float voltage, float temperature)
{   
    this->_voltage = voltage;
    this->_temperature = temperature;
...
boolean DFRobot_EC_10::cmdSerialDataAvailable()
{
...
byte DFRobot_EC_10::cmdParse(const char* cmd)
{
    byte modeIndex = 0;
...
void DFRobot_EC_10::ecCalibration(byte mode)
{
